Ext.define('EventMap.controller.Application', {
    ...
    onContactSelect: function(list, index, node, record) {
        ...
        if (!this.showContact) {
            this.showContact = Ext.create('EventMap.view.contact.Show');
        }
    ...
    onContactEdit: function() {
        if (!this.editContact) {
            this.editContact = Ext.create('EventMap.view.contact.Edit');
        }
